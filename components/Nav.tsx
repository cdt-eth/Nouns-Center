...
const Nav = ({ setSidebarOpen }) => {
  return (
    <div className="flex flex-col flex-grow  pt-5 pb-4 bg-grey-base dark:bg-nouns-bg-darkgrey overflow-y-auto">
      <Link passHref href="/">
        <div
      ...
      <div className="flex-grow flex flex-col">
        <nav
          className="flex-1 px-4 space-y-1 bg-grey-base dark:bg-nouns-bg-darkgrey"
          aria-label="Sidebar"
        >
          {/* No SubNav */}
          {nav.map(
