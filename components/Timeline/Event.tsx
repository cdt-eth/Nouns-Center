...
const Event = ({ date, title, body, img, link, buttonText, idx }: EventProps) => {
  return (
    <VerticalTimelineElement
      ...
      icon={<img className="rounded-full" src={getRandomNounPic(idx)} alt="noun" />}
    >
      <h3 className="vertical-timeline-element-title text-nouns capitalize ">{title}</h3>
