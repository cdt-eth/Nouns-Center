    ...
    <>
      <div className="relative overflow-hidden flex justify-around tracking-wider pt-10">
        <div className="relative pb-16 sm:pb-24 ">
          <main className="mx-auto sm:px-4 tracking-wider text-white ">
      ...
      <div className="relative text-white font-medium gap-2 items-center w-full flex flex-col text-center">
        <p>
        ...
        <div className="flex gap-8 items-center">
          ...
          {/* <img className="h-8" src="/icons/opensea.svg" alt="discord" /> */}
        </div>
      </div>
    </>
  );
