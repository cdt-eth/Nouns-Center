    ...
    <>
      ...
      <PageContent>
        <div className="flex gap-6 xs:flex-col-reverse sm:flex-row">
          <TextContent title="Overview">
            <p>
              ...
              <Link text="Nouns proposal 13" url="https://nouns.wtf/vote/13" leavesPage={true} />.
              It&apos;s run by a group of Nouners to be a &quot;flexible pool of capital&quot; that
              can be deployed when either the project is time sensitive, the ask is too small for an
              official proposal, or retroactive funding is merited because the work is already done.
        ...
        <TextContent title="Requesting a grant">
          <p>
            Open a post on{' '}
            <Link text="Discourse" url="https://discourse.nouns.wtf/" leavesPage={true} /> and
            prefix the title with <b>&quot;Small Grants: &quot;</b> for visibility. From there a
            committee member will reach out to you, but you can also post the link to your Discourse
            post in the{' '}
            <Link
              text="#grants-and-retro-funding"
              url="https://discord.com/channels/849745721544146955/903077530502828092"
          ...
          <ul className="list-disc list-inside pb-4">
            ...
            <li className="ml-6">How it will proliferate Nouns (or already has)</li>
            <li className="ml-6">
              How much upfront funding you want, if the projects completed the committee will decide
              on if/how much retro funds are given
            </li>
          </ul>
